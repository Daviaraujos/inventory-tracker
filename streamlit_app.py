...
try:
    ...
    leads_qualificados = df_filtrado[df_filtrado['Atende aos requisitos'] == 'Sim']['Number_leads'].count()
    leads_respondidos = df_filtrado[df_filtrado['Respondeu as msgns'] == 'Sim']['Number_leads'].count()
    propostas_aceitas = df_filtrado[df_filtrado['Aceitou'] == 'SIM']['Number_leads'].count()
    assinaturas_finalizadas = df_filtrado['Data da assinatura'].notnull().sum()
